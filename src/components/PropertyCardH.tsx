...
const PropertyCardH: FC<PropertyCardHProps> = ({
  ...
  return (
    <div
      className={`nc-PropertyCardH relative bg-white dark:bg-neutral-900 border border-neutral-200/80 dark:border-neutral-700 rounded-3xl overflow-hidden ${className}`}
    >
