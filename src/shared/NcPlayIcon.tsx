...
const NcPlayIcon: FC<NcPlayIconProps> = ({ className = '' }) => {
  return (
    <div
      className={`nc-NcPlayIcon bg-white bg-opacity-30 backdrop-filter backdrop-blur rounded-full w-20 h-20 p-3 lg:w-48 lg:h-48 lg:p-10 ${className}`}
      data-nc-id='NcPlayIcon'
    >
      <div className='w-full h-full bg-white rounded-full text-primary-500 relative'>
        <span className='absolute inset-0 flex items-center justify-center'>
          <svg
            className='w-9 h-9 lg:w-12 lg:h-12 ml-1 lg:ml-2'
            width='24'
            height='24'
            fill='currentColor'
            viewBox='0 0 24 24'
