  ...
  return (
    <div className='markdown-styles relative container my-12 xl:my-20'>
      ...
      <div className="md:-mt-[40vh]">
        ...
        <h2>Responsibilities of the Partner</h2>
        <p className="text-neutral-600 dark:text-neutral-300">
          Responsibility for Provided Information
          The partner is fully responsible for the accuracy and completeness of all information provided to WeltCar,
          including but not limited to vehicle details, pricing, availability, and delivery timelines. It is the partner's
          obligation to ensure that all information is up-to-date and accurate at the time it is communicated to WeltCar.
        </p>

        <h2>Quality and Timeliness of Deliveries</h2>
        <p className="text-neutral-600 dark:text-neutral-300">
          The partner is committed to delivering vehicles that meet the agreed-upon quality standards and within the
          timelines specified in the contract. Any delays or deviations from the agreed terms must be promptly
          communicated to WeltCar, along with an explanation and a proposed solution to mitigate the impact of such
          delays.
        </p>

        <h2>Providing Current Vehicle Prices</h2>
        <p className="text-neutral-600 dark:text-neutral-300">
          The partner must ensure that all vehicle prices provided to WeltCar are current and reflect the latest market
          conditions. The prices must include all applicable taxes, fees, and any other costs that may be incurred by the
          buyer. The partner is required to notify WeltCar immediately of any changes in pricing to ensure transparency
          and accuracy in all transactions.
        </p>

        <h2>Amendments to the Partner Agreement</h2>
        <p className="text-neutral-600 dark:text-neutral-300">
          WeltCar reserves the right to amend this Partner Agreement to align with new legal requirements, changes in the
          business environment, or updates in the service offerings. Partners will be notified of any significant changes
          to this agreement, and continued collaboration will signify acceptance of the updated terms.
        </p>

        <h2>For further inquiries or to discuss this agreement, please contact us at:</h2>
        <div className='text-neutral-600 dark:text-neutral-300'>
          <p>
            Email: <Link href="mailto:info@findax.eu">info@findax.eu</Link>
            <br />
            Address: Theodor-Fontane-Straße 2, 22848 Norderstedt, Germany
          </p>
        </div>
      </div>
    </div>
