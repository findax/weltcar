...
export default function CookiePolicyPage() {
  return (
    <div className='markdown-styles relative container my-12 xl:my-20'>
      <Image
        className='hidden md:block absolute inset-0 top-1/2 -translate-y-1/2 object-contain w-full max-w-7xl m-auto opacity-[0.07] -z-10'
        src={bgImg}
      ...
      <div className='text-neutral-600 dark:text-neutral-300'>
        ...
        <p>
          ...
          ever-changing websites. Despite careful content control, we assume no
        ...
        <p>
          ...
          from this website, please notify us immediately by electronic mail so
