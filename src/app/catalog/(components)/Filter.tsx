...
const Filter = ({ closeFilter }: { closeFilter: (value: boolean) => void }) => {
  ...
  // };
  return (
    <div className='overflow-y-auto h-screen lg:visible lg:h-auto pb-24 px-4 lg:py-6 lg:px-8 bg-white dark:bg-neutral-900 lg:rounded-2xl border border-neutral-200 dark:border-neutral-700'>
